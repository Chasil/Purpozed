    ...
    <div class="register">
            ...
            <div class="row row-item">
                <div class="post-item topic">
                    ...
                    <div class="row aoe-items">
                        <div class="expertises">
                            <?php foreach ($areas_of_expertise as $area): ?>
                                <div class="single-expertise project <?php echo ($areas_of_expertise[0]->id === $area->id) ? 'active' : ''; ?>"
                    ...
                    <div class="row column textarea-items">
                        ...
                        <div class="opportunity-textarea"><textarea data-validation="benefits" class="charNum"
                                                                    data-max="600"
                                                                    maxlength="600"
                    ...
                    <div class="row column textarea-items">
                        ...
                        <div class="opportunity-textarea"><textarea data-validation="benefits"
                                                                    class="charNum"
                                                                    data-max="600"
                                                                    maxlength="600"
        ...
        <div class="section not-first">
            <div class="row post-item">
                <div class="medium-header"><?php _e('Who will participate in the Project', 'purpozed'); ?>?</div>
            </div>
            ...
            <div class="columns">
                    ...
                    <div class="row buttons-box">
                        <?php if (!isset($opportunity)): ?>
                            <div class="done-button next skills"><input class="step-button" type="submit" name="post"
                                                                        value="<?php _e('POST THE PROJECT', 'purpozed'); ?>">
                            </div>
                        ...
                        <?php if (isset($opportunity)): ?>
                            <?php if ($opportunity->status === 'review'): ?>
                                <div class='matched-opportunity-box post'>
                                    <p><?php _e('Under review. You have posted this project and we are about to check and publish it within 24 hours.', 'purpozed'); ?></p>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                ...
                <div class="column preview">
                    ...
                    <div class="text prev-duration">
                        <?php if (isset($opportunity)): ?>
                            <?php _e('Hours', 'purpozed') . ': ' . $task->hours_duration; ?>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="text prev-benefits">
                        <?php if (isset($opportunity)): ?>
                            <?php echo stripslashes($opportunity->benefits); ?>
                        <?php endif; ?>
                    </div>
                    <div class="small-header"><?php _e('Additional Details', 'purpozed'); ?></div>
                    <div class="text prev-details">
                        <?php if (isset($opportunity)): ?>
                            <?php echo $opportunity->details; ?>
                        <?php endif; ?>
                    </div>
